 ...
 * @company 探索者网络工作室(www.tsz.net) <a href="http://my.oschina.net/arthor"
 *          class="referer" target="_blank">@author</a> michael Young
 *          (www.YangFuhai.com)
 * @version 1.0
 * @created 2012-9-29
 */
 ...
 * 添加滑动删除按钮
 * 更新事件的处理
 * 需要原版请参照 http://my.oschina.net/yangfuhai/blog/81137  michaely	
 * @update 2014/6/15
 *  update by Charles.Xu
 */
